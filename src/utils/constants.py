...
class Prompt:
    FUNCTION_CALLING_SYSTEM_PROMT = """
                    ...
                    You must automatically infer the time period based on the user's request.\
                    \
                    STRICT GUIDELINES (MUST BE FOLLOWED):\
                        ...
                        2. MUST CONFIRM ALL ARGUMENTS AND THE NEXT ACTION WITH THE USER before executing any function, ensuring the extracted information is correct.\
                        3. FUNCTION NAMES MUST REMAIN UNCHANGED. You must strictly select function names and their arguments only from the predefined function list. \
